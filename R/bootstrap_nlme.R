...
bootstrap.lme <- function(
  ...
  if (rbootnoise != 0) {
    stop(
      "'rbootnoise' implemented currently only for LME4 models. Do not define or use default 0."
    )
  }
