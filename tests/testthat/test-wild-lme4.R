...
test_that("two-level additive random intercept model",{
  ...
  boo <- wild_bootstrap.lmerMod(model = vcmodA, .f = mySumm, B = nsim, hccme = "hc2", aux.dist = "f1")
...
test_that("two-level random intercept model without interaction",{
  ...
  boo <- wild_bootstrap.lmerMod(model = rimod, .f = mySumm, B = nsim, hccme = "hc2", aux.dist = "f1")
...
test_that("two-level random intercept model with interaction",{
  ...
  boo <- wild_bootstrap.lmerMod(model = vcmodC, .f = mySumm, B = nsim, hccme = "hc2", aux.dist = "f1")
...
test_that("two-level random coefficient model with interaction",{
  ...
  boo <- wild_bootstrap.lmerMod(model = rcmod, .f = mySumm, B = nsim, hccme = "hc2", aux.dist = "f1")
...
test_that("three-level random intercept model",{
  ...
  boo <- wild_bootstrap.lmerMod(model = rmA, .f = mySumm, B = nsim, hccme = "hc2", aux.dist = "f1")
...
test_that("two-level additive random intercept model",{
  ...
  boo <- wild_bootstrap.lmerMod(model = vcmodA, .f = mySumm, B = nsim, hccme = "hc2", aux.dist = "f2")
...
test_that("two-level random intercept model without interaction",{
  ...
  orig.stats <- mySumm(rimod)
  boo <- wild_bootstrap.lmerMod(model = rimod, .f = mySumm, B = nsim, hccme = "hc2", aux.dist = "f2")
...
test_that("two-level random intercept model with interaction",{
  ...
  orig.stats <- mySumm(vcmodC)
  boo <- wild_bootstrap.lmerMod(model = vcmodC, .f = mySumm, B = nsim, hccme = "hc2", aux.dist = "f2")
...
test_that("two-level random coefficient model with interaction",{
  ...
  orig.stats <- mySumm(rcmod)
  boo <- wild_bootstrap.lmerMod(model = rcmod, .f = mySumm, B = nsim, hccme = "hc2", aux.dist = "f2")
...
test_that("three-level random intercept model",{
  ...
  orig.stats <- mySumm(rmA)
  boo <- wild_bootstrap.lmerMod(model = rmA, .f = mySumm, B = nsim, hccme = "hc2", aux.dist = "f2")
...
test_that("two-level additive random intercept model",{
  ...
  boo <- wild_bootstrap.lmerMod(model = vcmodA, .f = mySumm, B = nsim, hccme = "hc3", aux.dist = "f1")
...
test_that("two-level random intercept model without interaction",{
  ...
  orig.stats <- mySumm(rimod)
  boo <- wild_bootstrap.lmerMod(model = rimod, .f = mySumm, B = nsim, hccme = "hc3", aux.dist = "f1")
...
test_that("two-level random intercept model with interaction",{
  ...
  orig.stats <- mySumm(vcmodC)
  boo <- wild_bootstrap.lmerMod(model = vcmodC, .f = mySumm, B = nsim, "hc3", aux.dist = "f1")
...
test_that("two-level random coefficient model with interaction",{
  ...
  orig.stats <- mySumm(rcmod)
  boo <- wild_bootstrap.lmerMod(model = rcmod, .f = mySumm, B = nsim, hccme = "hc3", aux.dist = "f1")
...
test_that("three-level random intercept model",{
  ...
  orig.stats <- mySumm(rmA)
  boo <- wild_bootstrap.lmerMod(model = rmA, .f = mySumm, B = nsim, hccme = "hc3", aux.dist = "f1")
...
test_that("two-level additive random intercept model",{
  ...
  boo <- wild_bootstrap.lmerMod(model = vcmodA, .f = mySumm, B = nsim, hccme = "hc3", aux.dist = "f2")
...
test_that("two-level random intercept model without interaction",{
  ...
  orig.stats <- mySumm(rimod)
  boo <- wild_bootstrap.lmerMod(model = rimod, .f = mySumm, B = nsim, hccme = "hc3", aux.dist = "f2")
...
test_that("two-level random intercept model with interaction",{
  ...
  orig.stats <- mySumm(vcmodC)
  boo <- wild_bootstrap.lmerMod(model = vcmodC, .f = mySumm, B = nsim, hccme = "hc3", aux.dist = "f2")
...
test_that("two-level random coefficient model with interaction",{
  ...
  orig.stats <- mySumm(rcmod)
  boo <- wild_bootstrap.lmerMod(model = rcmod, .f = mySumm, B = nsim, hccme = "hc3", aux.dist = "f2")
...
test_that("three-level random intercept model",{
  ...
  orig.stats <- mySumm(rmA)
  boo <- wild_bootstrap.lmerMod(model = rmA, .f = mySumm, B = nsim, hccme = "hc3", aux.dist = "f2")
