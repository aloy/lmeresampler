...
set.seed(7142015)
boo <- reb_bootstrap.lme(model = vcmodA, fn = mySumm, B = nsim, reb_type = 0)
...
boo <- reb_bootstrap.lme(model = vcmodC, fn = mySumm, B = nsim)
...
boo <- reb_bootstrap.lme(model = rcmod, fn = mySumm, B = nsim)
...
set.seed(7142015)
boo <- reb_bootstrap.lme(model = vcmodA, fn = mySumm, B = nsim, reb_type = 1)
...
orig.stats <- mySumm(vcmodC)
boo <- reb_bootstrap.lme(model = vcmodC, fn = mySumm, B = nsim, reb_type = 1)
...
orig.stats <- mySumm(rcmod)
boo <- reb_bootstrap.lme(model = rcmod, fn = mySumm, B = nsim, reb_type = 1)
...
set.seed(7142015)
boo <- reb_bootstrap.lme(model = vcmodA, fn = mySumm, B = nsim, reb_type = 2)
...
orig.stats <- mySumm(vcmodC)
boo <- reb_bootstrap.lme(model = vcmodC, fn = mySumm, B = nsim, reb_type = 2)
