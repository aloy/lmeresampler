...
boo1 <- residual.lmerMod(model = vcmodA, fn = mySumm, B = 1000)

boo2 <- residual.lmerMod(model = vcmodC, fn = mySumm, B = 1000)
...
mySumm2(rmA)
boo3 <- residual.lmerMod(model = rmA, fn = mySumm2, B = 1000)
